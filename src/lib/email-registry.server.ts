...
export const EMAIL_TEMPLATES: EmailTemplateMeta[] = [
  ...
  { key: "study_sent", label: "Cahier des charges — envoi au client",
    category: "pv", recipient: "client", retryable: true, status: "stable",
    description: "Pré-étude avant-vente envoyée au client avec le PDF et la synthèse (aucune note interne)." },
