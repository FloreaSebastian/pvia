  ...
  .handler(async ({ data, context }) => {
    ...
    const manifest = {
      ...
      report: {
        ...
        signer_name: (report as any).signer_name,
        signer_role: (report as any).signer_role,
        signer_email: (report as any).signer_email,
        signer_signed_at: (report as any).signer_signed_at,
        validation_mode: (report as any).validation_mode,
        client_signed_on_site: (report as any).client_signed_on_site,
        client_signature_email: (report as any).client_signature_email,
        client_signature_otp_id: (report as any).client_signature_otp_id,
